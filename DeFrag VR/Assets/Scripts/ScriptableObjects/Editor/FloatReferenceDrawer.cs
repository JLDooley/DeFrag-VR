...
{
    [CustomPropertyDrawer(typeof(FloatReference))]  //FloatReference class is the SerializedProperty value
    public class FloatReferenceDrawer : PropertyDrawer
    {
        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)    /*Draw the property inside a rect.
                                                                                                    ...
                                                                                                    SerializedProperty property = FloatReference instance
                                                                                                    GUIContent label = name of FloatReference instance*/
        {
            ...
            SerializedProperty variable = property.FindPropertyRelative("Variable");                //public FloatVariable Variable
            ...
            EditorGUI.PropertyField(position, useConstant.boolValue ? constantValue : variable, GUIContent.none);   //Display FloatReference.constantValue in Inspector if useConstant is true, or FloatReference.variable if false
            #endregion

            if (EditorGUI.EndChangeCheck())      //returns true if a change to the properties in the Inspector occured, update the associated properties in the source FloatReference
            {
